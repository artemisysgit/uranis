            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 d-flex justify-content-between align-items-center">
                        ...
                        <!--Breadcrumbs-->
                        <div class="breadcrumbs"><a href="#" title="Back to the home page">Home</a>
                        ...
                        <div class="sidebar-widget clearfix categories">
                            ...
                            <div class="widget-content">
                                <ul class="sidebar-categories scrollspy clearfix">
                                    ...
                                    ?>
                                        <li class="lvl-1"><a href="<?php echo site_url("/blog-category/$cat_slug"); ?>" class="site-nav lvl-1"><?= $cat_name; ?> <span class="count">(<?= $post_count; ?>)</span></a></li>
                                    <?php } ?>
