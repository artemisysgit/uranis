...
$why_choose = get_term_meta($category_id, 'why_choose', true);
$highlights = get_term_meta($category_id, 'custom_description', true);
$shipping = get_term_meta($category_id, 'shipping_information', true);
$how_order = get_term_meta($category_id, 'how_to_order', true);
$faq = get_term_meta($category_id, 'faq', true);
    ...
    <div class="container" id="result1">
        ...
        <div class="tag" id="tag">
            <?php if ($category_name != "") { ?>
                <div class="newtags" id="cat_tag">
                    <?php echo $category_name; ?>
                    <a href="<?php echo site_url('/product/'); ?>" class="tag-link">x</a>
                </div>
            <?php } ?>
            <span id="brand_tags"></span>
        </div>
                ...
                <div class="tabs-listing section pb-0">
                    <ul class="product-tabs style2 list-unstyled d-flex-wrap d-none d-md-flex justify-content-center  ">
                        ...
                        <?php if ($category_desc) : ?>
                            <li rel="description"><a class="tablink">Description</a></li>
                        <?php endif; ?>
                        <?php if ($highlights) : ?>
                            <li rel="highlights"><a class="tablink">Highlights</a></li>
                        <?php endif; ?>
                        <?php if ($why_choose) : ?>
                            <li rel="why_choose"><a class="tablink">Why Uranis?</a></li>
                        <?php endif; ?>
                        <?php if ($shipping) : ?>
                            <li rel="shipping"><a class="tablink">Shipping Information</a></li>
                        <?php endif; ?>
                        <?php if ($how_order) : ?>
                            <li rel="how_order"><a class="tablink">How To Order?</a></li>
                        <?php endif; ?>
                        <?php if ($faq) : ?>
                    ...
                    <div class="tab-container">
                        ...
                        <h3 class="tabs-ac-style rounded-5 d-md-none" rel="description">Description</h3>
                        <div id="description" class="tab-content">

                            <?php
                            //echo apply_filter($description);
                            echo apply_filters('category_archive_meta',  wpautop($category_desc));
                            ?>
                        </div>
                        ...
                        <div id="highlights" class="tab-content">
                            ...
                            echo apply_filters('category_archive_meta',  wpautop($highlights));
                            ?>
                        </div>
                        <h3 class="tabs-ac-style rounded-5 d-md-none" rel="why_choose">Why Uranis?</h3>
                        <div id="why_choose" class="tab-content">

                            <?php

                            echo apply_filters('category_archive_meta',  wpautop($why_choose));
                            ?>
                        </div>
                        <h3 class="tabs-ac-style rounded-5 d-md-none" rel="shipping">Shipping Information</h3>
                        <div id="shipping" class="tab-content">

                            <?php
                            //echo $shipping;
                            echo apply_filters('category_archive_meta',  wpautop($shipping));
                            ?>
                        </div>
                        <h3 class="tabs-ac-style rounded-5 d-md-none" rel="how_order">How To Order?</h3>
                        <div id="how_order" class="tab-content">

                            <?php

                            echo apply_filters('category_archive_meta',  wpautop($how_order));
                            ?>
                        </div>
                        <h3 class="tabs-ac-style rounded-5 d-md-none" rel="faq">How To Order?</h3>
                        <div id="faq" class="tab-content">

                            <?php
                            // echo $faq;
                            echo apply_filters('category_archive_meta',  wpautop($faq));
                            ?>
                        </div>
                    </div>
                </div>
    ...
    $(document).ready(function() {
        ...
        $(".cbx").click(function() {
            ...
            $.each(values, function(index, value) {
                ...
                // tags_html += '<div class="newtags">' + modified_tag + '</div><a href="javascript:void(0)" id="' + modified_tag + ' class="tag-link" onclick=function(modified_tag){}>x</a>';
